...
@SpringBootTest(
    properties = [
        ...
        "tenancy.databases.EMP1.url=jdbc:h2:mem:payments_emp1;MODE=PostgreSQL;DB_CLOSE_DELAY=-1",
        "tenancy.databases.EMP1.username=sa",
        "tenancy.databases.EMP1.password=",
        "tenancy.databases.EMP2.url=jdbc:h2:mem:payments_emp2;MODE=PostgreSQL;DB_CLOSE_DELAY=-1",
