package com.example.usbilling.payments.outbox
...
data class OutboxRelayProperties(
    ...
    var lockOwner: String = "payments-outbox-relay",
...
@Component
@ConditionalOnProperty(prefix = "payments.outbox.relay", name = ["enabled"], havingValue = "true")
