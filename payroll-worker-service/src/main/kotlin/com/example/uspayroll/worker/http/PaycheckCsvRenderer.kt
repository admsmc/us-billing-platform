...
object PaycheckCsvRenderer {
    ...
    private fun taxKey(ruleId: String, jurisdictionType: String, jurisdictionCode: String): String {
        // Keep stable and unique. Rule IDs may not be globally unique across jurisdictions.
    ...
    private fun formatDouble(v: Double): String {
        // Keep deterministic formatting for CSV diffs.
        // 4 decimals is enough for hours/units.
        return String.format(Locale.US, "%.4f", v)
    }

    private fun csvEscape(v: String): String {
        // All current fields are simple, but be safe.
