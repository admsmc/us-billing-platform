...
/**
 * DTO representation of a garnishment order as exposed by HR/garnishment
 * services over HTTP. This mirrors the domain model but uses primitive
 * identifier fields for easier wire compatibility.
 */
