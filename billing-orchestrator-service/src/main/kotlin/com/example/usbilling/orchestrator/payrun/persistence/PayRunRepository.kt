...
class PayRunRepository(
     ...
     */
    fun acceptCorrectionOfBillingCycleId(employerId: String, payRunId: String, correctionOfPayRunId: String): Boolean {
    ...
    fun findCorrectionOfBillingCycleId(employerId: String, payRunId: String): String? = jdbcTemplate.query(
        """
            SELECT correction_of_pay_run_id
            FROM pay_run
            WHERE employer_id = ? AND pay_run_id = ?
