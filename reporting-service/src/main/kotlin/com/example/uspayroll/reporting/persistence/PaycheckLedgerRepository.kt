...
class PaycheckLedgerRepository(
    ...
    fun listLedgerSummaryByEmployerAndCheckDateRange(employerId: String, startInclusive: LocalDate, endInclusive: LocalDate, limit: Int): List<LedgerEntrySummaryRow> {
    ...
    fun listLedgerPayloadsByEmployerAndCheckDateRange(employerId: String, startInclusive: LocalDate, endInclusive: LocalDate, limit: Int): List<LedgerEntryPayloadRow> {
        return jdbcTemplate.query(
            """
    ...
    fun findLedgerPayloadByEmployerAndPaycheckId(employerId: String, paycheckId: String): LedgerEntryPayloadRow? {
        return jdbcTemplate.query(
            """
            SELECT employer_id, paycheck_id, payload_json
            FROM paycheck_ledger_entry
    ...
    fun findLedgerSummaryByEmployerAndPaycheckId(employerId: String, paycheckId: String): LedgerEntrySummaryRow? {
        return jdbcTemplate.query(
            """
            SELECT employer_id, paycheck_id, employee_id,
                   pay_run_id, pay_run_type, run_sequence, pay_period_id,
    ...
    fun listNetTotalsByEmployerAndPayRun(employerId: String, payRunId: String, limit: Int): List<NetTotalsByEmployeeRow> {
        return jdbcTemplate.query(
            """
            SELECT employer_id,
                   pay_run_id,
