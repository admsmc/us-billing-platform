...
class OrchestratorClientRetryIT {
    ...
    fun `retries transient 5xx and succeeds`() {
        val result = client.getStatus(employerId = com.example.usbilling.shared.UtilityId("EMP"), payRunId = "PR")
...
class OrchestratorClientCircuitBreakerIT {
    ...
    fun `opens circuit after failures and fails fast`() {
        assertFailsWith<Exception> {
            client.getStatus(employerId = com.example.usbilling.shared.UtilityId("EMP"), payRunId = "PR")
        }
