...
class FilingsComputationService(
    ...
    private fun isFederalIncomeWithholding(line: PaycheckLedgerTaxLine): Boolean {
        return line.jurisdictionType == "FEDERAL" && line.jurisdictionCode == "US"
    }

    private fun isSocialSecurity(line: PaycheckLedgerTaxLine): Boolean {
        return line.jurisdictionType == "FEDERAL" && line.jurisdictionCode == "SS"
    }

    private fun isMedicare(line: PaycheckLedgerTaxLine): Boolean {
        return line.jurisdictionType == "FEDERAL" && line.jurisdictionCode == "MED"
    }

    private fun isFuta(line: PaycheckLedgerTaxLine): Boolean {
        return line.jurisdictionType == "FEDERAL" && line.jurisdictionCode == "FUTA"
    }
}
