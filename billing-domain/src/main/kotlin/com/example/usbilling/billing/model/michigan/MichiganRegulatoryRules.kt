...
object MichiganElectricSurcharges {
     ...
     */
    fun powerSupplyCostRecovery(ratePerKwh: Money = Money(125)): RegulatorySurcharge = RegulatorySurcharge(
        code = "PSCR",
     ...
     */
    fun systemAccessFee(monthlyAmount: Money = Money(700)): RegulatorySurcharge = RegulatorySurcharge(
        code = "SAF",
     ...
     */
    fun liheapSurcharge(percentageRate: Double = 0.5): RegulatorySurcharge = RegulatorySurcharge(
        code = "LIHEAP",
     ...
     */
    fun energyOptimization(percentageRate: Double = 2.0): RegulatorySurcharge = RegulatorySurcharge(
        code = "EO",
     ...
     */
    fun renewableEnergyStandard(ratePerKwh: Money = Money(50)): RegulatorySurcharge = RegulatorySurcharge(
        code = "RES",
...
object MichiganWaterSurcharges {
     ...
     */
    fun infrastructureCharge(percentageRate: Double = 2.0): RegulatorySurcharge = RegulatorySurcharge(
        code = "INFRA",
     ...
     */
    fun leadServiceLineReplacement(monthlyAmount: Money = Money(300)): RegulatorySurcharge = RegulatorySurcharge(
        code = "LSLR",
     ...
     */
    fun stormwaterManagement(monthlyAmount: Money = Money(500)): RegulatorySurcharge = RegulatorySurcharge(
        code = "STORM",
...
object MichiganStandardSurcharges {
     ...
     */
    fun forElectric(): List<RegulatorySurcharge> = listOf(
     ...
     */
    fun forWater(): List<RegulatorySurcharge> = listOf(
     ...
     */
    fun forWastewater(): List<RegulatorySurcharge> = listOf(
        MichiganWaterSurcharges.infrastructureCharge(),
     ...
     */
    fun all(): List<RegulatorySurcharge> = forElectric() + forWater() + forWastewater()
}
