...
class LaborClientConfig {
    ...
    @Bean
    fun httpLaborStandardsClient(props: LaborClientProperties, hrRestTemplate: RestTemplate): LaborStandardsClient = HttpLaborStandardsClient(props, hrRestTemplate)
}
